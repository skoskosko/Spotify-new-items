...
class MyHomePage extends StatefulWidget {
  ...
  final String title;
  final url = Uri.https('account.spotify.com', '/authorize');
  //final result = FlutterWebAuth.authenticate(url: 'https://accounts.spotify.com/authorize?client_id=', callbackUrlScheme: null);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() async {
      ...
      var hmm = ApiUrls.ownFollowedPlaylists;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: _buildCounterButton(context), // This trailing comma makes auto-formatting nicer for build methods.
    );
  }
  Widget _buildCounterButton(context) {
        ...
        children: <Widget>[
          ...
          FloatingActionButton(
            onPressed: (){
              ...
              _isButtonDisabled ? null : this._incrementCounter();
            },
            child: Icon(Icons.add),
          ),
          Spacer(
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("testi ikkuna"),
      content: Text("testiä vaan tässä"),
      actions: [
        okButton
      ],
    );
